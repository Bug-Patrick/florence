...
class StructuralDynamicIntegrator(object):
    ...
    def GetBoundaryInfo(self, mesh, formulation, boundary_condition, increment=0):
        ...
        if formulation.fields == "electro_mechanics":
            ...
            self.columns_out_mech_reverse_idx = np.isin(boundary_condition.columns_out,self.columns_out_mech)
            ...
            self.columns_out_electric_reverse_idx = np.isin(boundary_condition.columns_out,
