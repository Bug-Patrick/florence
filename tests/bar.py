...
def bar():
    ...
    material = NeoHookean(3, lamb=lame_parameter_1, mu=lame_parameter_2) # first parameter ndim

    def DirichletFunc(mesh):
        # homogenous Dirichlet boundary at elements 10 11 22 23 49
    ...
    def NeumannFuncDyn(mesh):
        # Neumann boundary with -100 force in x or y direction at element 44
    ...
    results.WriteVTK("bar_results", quantity=0) # What is quantity?
